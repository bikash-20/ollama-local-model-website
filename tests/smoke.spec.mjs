// Nocta smoke tests — end-to-end checks that catch the most common
...
//   3. Legacy remote-backend state is migrated away on next boot, and the
//      local model picker stays scrollable.
//
